...
<template>
  <aside class="left-panel">
    ...
    >
      <svg width="20" height="20" :viewBox="tool.viewBox ?? '0 0 20 20'" fill="none" v-html="tool.svg" />
